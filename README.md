...
- [`fixtures/vectors/`](fixtures/vectors/) — Byte-exact test vectors for the stranger test (G-3). Directory-per-vector layout with TOML manifest, narrative derivation evidence citing Core prose only, and committed cryptographic intermediates. First reference vector lives at `append/001-minimal-inline-payload/`. Governed by [`thoughts/specs/2026-04-18-trellis-g3-fixture-system-design.md`](thoughts/specs/2026-04-18-trellis-g3-fixture-system-design.md); authored via [`thoughts/specs/2026-04-18-trellis-g3-fixture-scaffold-plan.md`](thoughts/specs/2026-04-18-trellis-g3-fixture-scaffold-plan.md).
