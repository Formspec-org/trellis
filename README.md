...
**Trellis is the cryptographic integrity substrate** for the **[Formspec](https://github.com/Formspec-org/formspec)** (intake) + **[WOS](https://github.com/Formspec-org/work-spec)** (governance) stack. It specifies the envelope, chain, checkpoint, and export-bundle format by which a Formspec response and its downstream WOS governance events become a single append-only, signed, offline-verifiable record.
