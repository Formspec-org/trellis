...
|---|---|---|---|---|---|---|---|
| TR-CORE-001 | core | — | Implementations MUST preserve the canonical append contract. | The contract is what interop rests on. | test-vector | — | Synthetic test row — no vector provided. |
