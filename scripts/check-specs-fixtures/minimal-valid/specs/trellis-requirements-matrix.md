...
Minimal matrix stub for lint test harness. Contains exactly one row.
...
|---|---|---|---|---|---|---|---|
| TR-CORE-001 | core | 1 | Implementations MUST preserve the canonical append contract. | The contract is what interop rests on. | test-vector | — | Synthetic test row. |
