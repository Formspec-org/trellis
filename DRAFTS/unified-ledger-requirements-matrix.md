...
This document extracts normative requirements from the legacy draft [`unified_ledger_core.md`](unified_ledger_core.md) into a traceability matrix with stable IDs. **Canonical copy:** [`../specs/core/unified-ledger-requirements-matrix.md`](../specs/core/unified-ledger-requirements-matrix.md) (prefer for edits). This DRAFTS file is kept aligned for working-copy traceability.

**Synthesis rows** **ULCR-095–103** record integrator-critical guarantees from normalized [`../specs/core/trellis-core.md`](../specs/core/trellis-core.md), [`../specs/core/shared-ledger-binding.md`](../specs/core/shared-ledger-binding.md), [`../specs/trust/trust-profiles.md`](../specs/trust/trust-profiles.md), [`../specs/projection/projection-runtime-discipline.md`](../specs/projection/projection-runtime-discipline.md), and [`trellis_spec_family_normalization_plan.md`](trellis_spec_family_normalization_plan.md) where the legacy omnibus was silent or less explicit.
...
| ULCF-036 | Integrator-critical ledger guarantees (normalized core + family boundaries) | [`../specs/core/trellis-core.md`](../specs/core/trellis-core.md) §5–9; [`../specs/core/shared-ledger-binding.md`](../specs/core/shared-ledger-binding.md); plan §4 |
| ULCF-037 | Canonical receipt immutability (binding) | [`../specs/core/shared-ledger-binding.md`](../specs/core/shared-ledger-binding.md) §Canonical receipt immutability |
...
| ULCR-056 | ULCF-010 | Canonical order | No workflow/projection/auth/collaboration layer MAY define alternate canonical order. | MAY NOT | CS | 9.1 |
...
Staff-facing **projection watermarks**, **stale indication**, **purge cascades**, and **rebuild/conformance expectations** are tracked in [`unified-ledger-companion-requirements-matrix.md`](unified-ledger-companion-requirements-matrix.md) (**ULCOMP-R-215–220**) and [`../specs/projection/projection-runtime-discipline.md`](../specs/projection/projection-runtime-discipline.md).

**Metadata budget** (per fact family) is tracked in the companion matrix (**ULCOMP-R-221**) and [`../specs/trust/trust-profiles.md`](../specs/trust/trust-profiles.md).
...
6. **ULCR-095–098** are anchored in [`../specs/core/trellis-core.md`](../specs/core/trellis-core.md); update them if that document’s §§5–9 change.
7. **ULCR-099** tracks [`../specs/core/shared-ledger-binding.md`](../specs/core/shared-ledger-binding.md) §Substrate binding; **ULCR-100** tracks [`../specs/core/trellis-core.md`](../specs/core/trellis-core.md) §10.1 and the normalization plan and aligns companion **ULCOMP-R-213–214** (legacy App. G).
8. **ULCR-101–102** track [`../specs/core/trellis-core.md`](../specs/core/trellis-core.md) §6.1–6.2; **ULCR-103** tracks [`../specs/core/shared-ledger-binding.md`](../specs/core/shared-ledger-binding.md) §Canonical receipt immutability.
9. Tiered **verification posture** for workflows and **projection integrity policy** are in the companion matrix (**ULCOMP-R-222–223**) with [`../specs/trust/trust-profiles.md`](../specs/trust/trust-profiles.md) and [`../specs/projection/projection-runtime-discipline.md`](../specs/projection/projection-runtime-discipline.md).

When `unified_ledger_core.md` text moves into [`../specs/core/trellis-core.md`](../specs/core/trellis-core.md) and companion drafts, keep **ULCR** IDs stable in migrated sections or add a “Migrated as ULCR-NNN” line for traceability.
