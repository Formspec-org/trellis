...
**Plan 3 refactor (2026-04-15):** this matrix was refactored to reflect the three-spec dependency direction — Formspec (bottom) ← WOS (references Formspec) ← Trellis (references both). Rows whose normative content moved upstream (to WOS Assurance, WOS Governance, or Formspec Respondent Ledger) were removed from this matrix and only ledger-specific obligations retained. Rows removed in Plan 3 are indexed in `cross-reference-map.md` with their upstream home.
...
### 6.7 Trust Profile Semantics, Honesty, and Transitions (ULCR-061 – ULCR-065, gap at ULCR-063)
...
| ULCR ID | ULCF ID | Feature Name | Requirement Summary | Keyword | Class | Status | § Authoritative | § Legacy | Owner |
|---|---|---|---|---|---|---|---|---|---|
| ULCR-073 | ULCF-020 | Companion discipline | _(Collapsed: entirely restated by ULCR-001 through ULCR-005. Superseded.)_ | — | — | Superseded | — | 13.1 | — |
...
### 6.10 Standard Profiles — Custody-Mode Bindings (Delegated) (ULCR-076 – ULCR-079)

The four custody-mode Standard Profiles are ledger-specific and retained here. Generic data-contract profiles (User-Held Record Reuse, Respondent History) that were previously ULCR-080 and ULCR-081 have authoritative homes in [Formspec Respondent Ledger §6.6A, §6.7] and were removed from this matrix in Plan 3; see [`../cross-reference-map.md`](../cross-reference-map.md).
...
| ULCR-113 | ULCF-040 | Legacy Invariant — Author-Originated Fact vs Append Attestation | _(Collapsed: subsumed by ULCR-038 and ULCR-047. Superseded.)_ | — | — | Superseded | — | 7.1 Invariant 1 | — |
| ULCR-114 | ULCF-040 | Legacy Invariant — Canonical Fact vs Canonical Record | _(Collapsed: subsumed by ULCR-048. Superseded.)_ | — | — | Superseded | — | 7.1 Invariant 2 | — |
