...
pub enum VerificationFailureKind {
    ...
    RescissionTerminalityViolation,
    ResponseRefMismatch,
    RevokedAuthority,
    ScopeMismatch,
...
impl VerificationFailureKind {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::ClockCalendarMismatch => "clock_calendar_mismatch",
            ...
            Self::RescissionTerminalityViolation => "rescission_terminality_violation",
